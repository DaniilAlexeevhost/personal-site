...
const principles = [
  "Думать длиннее, чем требует момент.",
  "Собирать наблюдения до готовых выводов.",
  "Смотреть на продукт как на систему.",
  "Учиться через практику, вопросы и разборы.",
];
      ...
      <section className="max-w-6xl mx-auto px-5 pt-20 pb-7 sm:px-6 sm:pt-22 sm:pb-8">
        <div className="mx-auto max-w-[46rem] text-center">
          ...
          <h1 className="mx-auto max-w-[40rem] text-[1.55rem] font-semibold leading-[1.12] tracking-tight text-zinc-950 sm:text-[1.9rem] md:text-[2.15rem]">
            Спокойная база для продуктового мышления
          </h1>

          <p className="mx-auto mt-3 max-w-[34rem] text-[0.95rem] leading-7 text-zinc-600 sm:text-[1rem]">
            Небольшое пространство для размышлений, заметок и исследований о
            продуктах, цифровых системах, росте, поведении пользователей и
            процессе обучения.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-5 py-7 sm:px-6 sm:py-9 lg:py-10">
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:gap-12">
            <aside className="lg:sticky lg:top-28 lg:self-start">
              <div className="max-w-sm space-y-9">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {keywords.map((keyword) => (
                      <Link
                        ...
                        className="rounded-full border border-zinc-200 bg-white px-3 py-1 text-xs font-medium leading-5 text-zinc-600 transition hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-950 hover:opacity-90"
                      >
                        {keyword}
                      </Link>
                    ))}
            ...
            <article className="max-w-[44rem] space-y-5 text-[1rem] leading-8 text-zinc-600 sm:text-[1.05rem]">
              <p>
                Этот проект можно воспринимать как открытый рабочий стол:
                место, где постепенно появляются мысли, вопросы, короткие
                заметки, исследовательские наброски и выводы из практики.
              </p>

              <p>
                Здесь важен не шум вокруг результата, а сам процесс
                формирования взгляда. Иногда это разбор идеи, иногда
                наблюдение за пользовательским поведением, иногда попытка
                понять, почему один продукт ощущается живым, а другой остается
                набором функций.
              </p>

              <p>
                Основной интерес проекта находится на пересечении продуктов,
                исследований, системного мышления и роста. Продукт здесь не
                только интерфейс или набор метрик, а способ организовать
                поведение, ценность, решения и обратную связь.
              </p>

              <p>
                Это спокойное пространство без необходимости постоянно
                производить громкие выводы. Скорее, это долгий журнал
                обучения: с промежуточными формулировками, рабочими
                гипотезами, практическими заметками и попытками думать точнее.
              </p>
            </article>
          </div>
        </div>
